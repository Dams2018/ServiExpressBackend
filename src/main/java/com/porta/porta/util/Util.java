...
public class Util {
	...
	public static class Codigos {
		...
		public static final String PASSWORDSNOCOINCIDENTES = "ERR-428;El servidor requiere que la petición del navegador sea condicional (la idUsuario se modificado por otra parte)";
